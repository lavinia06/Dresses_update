...
urlpatterns = [
    ...
    path('shows/', views.redcarpetpres_list),
    ...
    path('dresses/filter/<int:price>', views.filter_dresses),
    path('shows/filter/<int:nr_guests>', views.filter_shows),
    ...
    path('dresses/dresses-ordered-by-price', views.FilterDresses.as_view(), name='dresses-ordered-by-price'),
